...
var amadeus = new Amadeus({
    clientId: 'FVuVxbamReEQaaK9Q9zMVBizmIBvuyc3',
    clientSecret: 'm0ZpJUZjracBDazZ'
});
...
app.get('/airports', async (req, res) => {
    const amadeus = new Amadeus({
        clientId: 'nv2G52vAAa0peZAgCFQ1aNvJreKLphhZ',
        clientSecret: 'BO5aAUDJZhzAT21u'
    });
...
app.listen(7000, () => {console.log("Server started on Port 5000")});
